...
<head>
    ...
    {{-- Custom CSS --}}
    <link href="{{ asset('css/layoutcss/auth.css') }}" rel="stylesheet">
</head>
...
<body class="font-main">
    ...
    <header class="header-container">
        ...
        <div class="header-text">
            <h1 class="font-luckiest text-dark">Khakiel Petshop</h1>
            <p class="text-secondary mb-1">Kebutuhan hewan kucing terlengkap</p>
        </div>
    </header>
    ...
    {{-- Footer --}}
    <footer class="px-4 py-4 text-muted">
        <div class="footer-container">
            ...
            <div class="footer-contact text-end">
                <a href="https://api.whatsapp.com/send?phone=6287717649173" target="_blank" class="text-decoration-none d-inline-flex align-items-center gap-2 fw-semibold text-dark">
                    {{-- SVG WhatsApp --}}
                    <svg fill="#000000" height="20" width="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 308 308">
