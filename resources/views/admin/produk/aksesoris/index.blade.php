...
<div class="container py-4">
    ...
    <div class="d-flex flex-column flex-md-row align-items-center justify-content-between bg-light px-4 py-3 rounded shadow mb-4 gap-3">
        <a href="{{ route('makanan-kucing.create') }}" class="btn btn-secondary">
            + Tambah Produk
        </a>

        <h2 class="h5 text-center flex-grow-1 mb-0 text-dark fw-bold">Kelola Produk Makanan Kucing</h2>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-center gap-2">
                                <a href="{{ route('makanan-kucing.edit', $p->id) }}" class="btn btn-warning btn-sm">
                                    Edit
                                </a>
                                <form action="{{ route('makanan-kucing.destroy', $p->id) }}" method="POST" onsubmit="return confirm('Yakin ingin hapus produk ini?')">
                                    @csrf
                                    @method('DELETE')
