...
<div class="form-wrapper">
    ...
    <form action="{{ route('admin.aksesoris.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama" id="nama" value="{{ old('nama') }}" required class="form-control bg-light">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="kategori" id="kategori" value="{{ old('kategori', 'aksesoris') }}" required class="form-control bg-light">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="stok" id="stok" value="{{ old('stok') }}" required class="form-control bg-light">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="harga" id="harga" value="{{ old('harga') }}" required class="form-control bg-light">
