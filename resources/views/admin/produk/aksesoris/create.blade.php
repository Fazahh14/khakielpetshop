...
@section('title', 'Tambah Produk Aksesoris')
...
<div class="max-w-4xl mx-auto bg-[#E5CBB7] rounded-3xl shadow-lg p-8 flex flex-col md:flex-row items-center gap-8">
    ...
    <div class="w-full md:w-1/2">
        ...
        <form action="{{ route('aksesoris.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="nama" id="nama" value="{{ old('nama') }}" required
                    class="w-full px-4 py-2 border rounded-md bg-[#FFFCF0] focus:outline-none focus:ring-2 focus:ring-orange-300">
            ...
            <div>
                ...
                <input type="text" name="kategori" id="kategori" value="{{ old('kategori', 'aksesoris') }}" required
                    class="w-full px-4 py-2 border rounded-md bg-[#FFFCF0] focus:outline-none focus:ring-2 focus:ring-orange-300">
            ...
            <div>
                ...
                <textarea name="deskripsi" id="deskripsi" rows="4"
                    class="w-full px-4 py-2 border rounded-md bg-[#FFFCF0] focus:outline-none focus:ring-2 focus:ring-orange-300">{{ old('deskripsi') }}</textarea>
            ...
            <div>
                ...
                <input type="file" name="gambar" id="gambar"
                    class="block w-full text-sm text-gray-800 file:mr-4 file:py-2 file:px-4
                           ...
                           hover:file:bg-orange-300 transition cursor-pointer" />
